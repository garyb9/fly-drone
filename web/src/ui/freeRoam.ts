export function renderFreeRoamButtons(): string {
  return `
<div class="bar-row bar-row-roam" id="roam-buttons" hidden>
...
<div class="bar-cell"><span class="bar-label">bridge</span><div class="button-row"><button id="roam-codec" title="Declared bridge codec. v3 (C4a) is the default; v2 is the P4 faithful readout and v1 the legacy canonical codec. Switching resets the sim.">Codec v3</button></div></div>
</div>`;
}

export function renderFreeRoamReadout(): string {
  return `
<aside class="roam-readout" id="roam-readout" hidden>
<div class="roam-readout-head">
...
<div id="roam-event" role="status" aria-live="polite">No free-roam events yet.</div>
</aside>`;
}
