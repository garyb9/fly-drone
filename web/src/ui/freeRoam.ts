...
<div class="bar-cell"><span class="bar-label">bridge</span><div class="button-row"><button id="roam-codec" title="Declared bridge codec. v2 (P4) is the default and fixes the idling; v1 is the legacy canonical codec. Switching resets the sim.">Codec v2</button></div></div>
</div>`;
}
