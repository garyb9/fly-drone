export function renderFreeRoam(): string {
  return `
<section class="bar-group bar-group-roam" id="roam-group" hidden>
<div class="bar-head"><h3>Free roam</h3><span class="bar-head-meta">level <b id="roam-level">—</b></span></div>
...
<div class="bar-foot"><span id="roam-event" role="status" aria-live="polite">No free-roam events yet.</span><span id="roam-visibility">Beacon —</span></div>
</section>`;
}
