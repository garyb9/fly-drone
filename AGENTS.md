...
| The brain stays the fly's | Wiring, weights, signs and neuron parameters are frozen. Learning lives in the decoder and, for free roam, the sensory encoder (camera images only; v5 = 8 uniform population currents, v6 = per-patch maps, both in [0, 2]; see docs/sensory-model.md §6–§7). Legacy actors stay on encoder v4. |
