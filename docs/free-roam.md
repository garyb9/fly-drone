...
| Threat    | dark sphere, r 0.25 m, thrown every 8–20 s from 3–4 m ahead at 0.9–1.3 m/s, aimed at the drone's launch-time position        | The looming pathway in flight. Intercept-lead aiming was dropped: it punished a committed dodge harder than random drift (teacher 49% vs random 68% dodged)                           |
